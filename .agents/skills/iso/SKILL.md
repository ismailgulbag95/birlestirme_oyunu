---
name: iso
description: "İstenen görev için gerekli becerileri resmi find-skills ile bulup kurar, ardından prompt-optimizer ile optimize edilmiş nihai promptu üretir. /iso komutu veya akıllı beceri keşfi için kullanılır."
---
