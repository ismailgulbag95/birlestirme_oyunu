...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_03_flora_food_items_1789715643609.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["acorn", "baobab", "berry", "cacao", "coconut"],
    ["sunflower", "candy", "caramel", "canned_food", "toast"],
    ["sandwich", "champagne", "barrel", "bouquet", "box"]
]
...
def process_sheet():
    ...
    print(f"Sheet 03 boyutu: {sheet_w}x{sheet_h}")
    ...
    for r in range(rows):
        for c in range(cols):
            ...
            # Alt kısımdaki yazı etiketlerini atlayabilmek için hücrenin %18 altını kırp
            bottom = int((r + 1) * cell_h - (cell_h * 0.17))
    ...
    print(f"\nPaket 3: Toplam {saved_count} flora/gıda görseli başarıyla üretildi!")
