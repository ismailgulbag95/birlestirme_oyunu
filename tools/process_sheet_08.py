...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_08_items_appliances_lifestyle_1789716558517.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["medicine", "soap", "perfume", "paint", "glue"],
    ["ring", "medal", "letter", "umbrella", "raincoat"],
    ["parachute", "fridge", "vacuum", "toy", "pipe"]
]
...
def process_sheet():
    ...
    print(f"Sheet 08 boyutu: {sheet_w}x{sheet_h}")
    ...
    print(f"\nPaket 8: Toplam {saved_count} yaşam/eşya görseli başarıyla üretildi!")
