...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_02_animals_fauna_1789715569196.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["bat", "beaver", "boar", "caterpillar", "crayfish"],
    ["crow", "cuckoo", "elephant", "firefly", "flamingo"],
    ["flying_fish", "fox", "giraffe", "hedgehog", "kangaroo"]
]
...
def process_sheet():
    ...
    print(f"Sheet 02 boyutu: {sheet_w}x{sheet_h}")
    ...
    for r in range(rows):
        for c in range(cols):
            ...
            # Alt satırdaki yazı etiketlerini kırpmak için bottom margin uygula
            if r == 2:
                bottom = int(bottom - (cell_h * 0.12))
    ...
    print(f"\nPaket 2: Toplam {saved_count} hayvan/canlı görseli başarıyla üretildi!")
