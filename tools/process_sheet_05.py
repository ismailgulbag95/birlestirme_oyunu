...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_05_characters_mythos_1789715850863.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["alien", "baby", "blood", "brain", "dna"],
    ["skeleton", "mummy", "knight", "pirate", "soldier"],
    ["spy", "firefighter", "scarecrow", "snowman", "pinocchio"]
]
...
def process_sheet():
    ...
    print(f"Sheet 05 boyutu: {sheet_w}x{sheet_h}")
    ...
    print(f"\nPaket 5: Toplam {saved_count} karakter görseli başarıyla üretildi!")
