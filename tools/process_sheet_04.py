...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_04_tools_gadgets_1789715760940.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["antenna", "balloon", "bandage", "binoculars", "boomerang"],
    ["broom", "brush", "bucket", "comb", "fan"],
    ["flashlight", "flask", "glasses", "grenade", "matches"]
]
...
def process_sheet():
    ...
    print(f"Sheet 04 boyutu: {sheet_w}x{sheet_h}")
    ...
    print(f"\nPaket 4: Toplam {saved_count} alet/nesne görseli başarıyla üretildi!")
