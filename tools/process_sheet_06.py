...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_06_mythos_cosmos_structures_1789716049090.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["black_hole", "supernova", "crystal_ball", "centaur", "cerberus"],
    ["hydra", "giant", "igloo", "skyscraper", "fountain"],
    ["grave", "labyrinth", "bonfire", "fireworks", "gasoline"]
]
...
def process_sheet():
    ...
    print(f"Sheet 06 boyutu: {sheet_w}x{sheet_h}")
    ...
    for r in range(rows):
        for c in range(cols):
            ...
            # Alt kısımdaki yazı etiketlerini atlayabilmek için hücrenin %16 altını kırp
            bottom = int((r + 1) * cell_h - (cell_h * 0.16))
    ...
    print(f"\nPaket 6: Toplam {saved_count} mitoloji/uzay görseli başarıyla üretildi!")
