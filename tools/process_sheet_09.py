...
SHEET_PATH = r"C:\Users\ismai\.gemini\antigravity-ide\brain\f1f0f847-c955-4abf-af01-da0772fab632\sheet_09_industry_tech_final_1789716779589.jpg"
OUTPUT_DIR = r"d:\github\birlestirme_oyunu\public\textures\items"

os.makedirs(OUTPUT_DIR, exist_ok=True)

ITEMS_GRID = [
    ["aluminium", "bitcoin", "calendar", "camouflage", "cardboard"],
    ["chemical_waste", "cross", "escalator", "explosive", "lamp"],
    ["lasso", "scuba", "tank", "weapon", "bit"]
]
...
def process_sheet():
    ...
    print(f"Sheet 09 boyutu: {sheet_w}x{sheet_h}")
    ...
    print(f"\nPaket 9: Toplam {saved_count} teknoloji/sanayi görseli başarıyla üretildi!")
